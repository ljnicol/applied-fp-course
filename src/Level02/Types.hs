...
errorToMessage :: Error -> LBS.ByteString
errorToMessage EmptyTopic     = "Missing topic"
errorToMessage EmptyComment   = "Missing comment"
errorToMessage InvalidRequest = "Invalid Request"
...
-- same thing with "guard syntax":
mkTopic t
  | Text.null t = Left EmptyTopic
...
getCommentText (CommentText a) = a
